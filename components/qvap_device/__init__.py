...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Optional("current_temp_sensor"): sensor.sensor_schema(UNIT_CELSIUS, ICON_THERMOMETER),
    cv.Optional("set_temp_sensor"): sensor.sensor_schema(UNIT_CELSIUS, ICON_THERMOMETER),
    cv.Optional("boost_temp_sensor"): sensor.sensor_schema(UNIT_CELSIUS, ICON_THERMOMETER),
    cv.Optional("superboost_temp_sensor"): sensor.sensor_schema(UNIT_CELSIUS, ICON_THERMOMETER),
    cv.Optional("battery_level_sensor"): sensor.sensor_schema(UNIT_PERCENT, ICON_THERMOMETER),
    cv.Optional("auto_shutoff_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("heater_mode_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("charger_status_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("settings_flags_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("brightness_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("vibration_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("device_prefix_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("device_name_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("heater_runtime_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("battery_charging_time_sensor"): sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY),
    cv.Optional("target_temp_number"): number.number_schema(
        UNIT_CELSIUS, ICON_THERMOMETER, 0, 100, 0.1, step=0.1),
